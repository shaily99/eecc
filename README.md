...
This is code for replicating the experiments in the paper [Extrinsic Evaluation of Cultural Competence in Large Language Models](https://arxiv.org/abs/2406.11565). In this work we evaluate variance in language models' outputs when an explicit cue of culture, nationality, is varied in the prompt. We also make the model outputs public for further analysis on [this huggingface data repository](https://huggingface.co/datasets/shaily99/eecc)
